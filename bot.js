...
const {Message, StringSession, Image, Video} = require('./Waxson/');
...
// ==================== Password Checking ====================
        ...
        if (Waxon.WAXONPW == 'WAXON' || Waxon.WAXONPW == 'WAXON' || Waxon.WAXONPW == 'Ꮥ н @ ∂ ø Ш') {
        //Coded by Shadow
        console.log(
            chalk.green.bold('✅PASSWORD DONE...\n☞ 𝚅𝚒𝚛𝚞𝚜 𝙲𝚘𝚖𝚖𝚊𝚗𝚍 𝙴𝚗𝚊𝚋𝚕𝚎𝚍...')
        );
         }
         else if (Waxon.WAXONPW !== 'WAXON' || Waxon.WAXONPW !== 'WAXON' || Waxon.WAXONPW !== 'Ꮥ н @ ∂ ø Ш') {
         console.log(
...
// ==================== End Check ====================
        ...
        console.log(
            chalk.green.bold('✅ Waxon-Bot working!')
        );
...
*/
                        try {
                            ...
                            if (config.LANG == 'TR' || config.LANG == 'AZ') {
                                ...
                                await conn.sendMessage(conn.user.jid, '__WAXSON_☠☠_[error] ' +
                                    '\n\n*👻 ' + error + '*\n'
                                    , MessageType.text);
                            }
                        }
